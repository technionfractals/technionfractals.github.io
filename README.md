...
- A Tally form is embedded in the Submit page.
...
4. Use **Site settings** to set page descriptions, participants, contact information, and the Tally embed URL.
...
Create a Tally form with the desired talk fields, copy its embed URL, and save it as `submit.formUrl` under **Site settings** in Pages CMS. Until that is set, the Submit page displays a not-connected state.
